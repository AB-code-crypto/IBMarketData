...
CANDIDATE_MIN_COUNT_VALUES = [3,7]  # [3,5,7]
CANDIDATE_MAX_COUNT_VALUES = [7,9,11]  # [7,9,11]
POTENTIAL_MIN_ABS_END_DELTA_POINTS_VALUES = [30]  # [30, 40]

DELAY_SECONDS_VALUES = [10]  # только значения, кратные 5
TAKE_PROFIT_POINTS_VALUES = [200]  # 0 отключает TP    пример: [0, 50.0, 100]
STOP_LOSS_POINTS_VALUES = [150]  # 0 отключает SL  пример: [0, 100.0, 150.0]
