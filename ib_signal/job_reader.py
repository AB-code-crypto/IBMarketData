...
def get_job_db_status(
    ...
    """Что делает: проверяет наличие job DB, таблицы, количества строк и свежесть последнего бара.
    Зачем нужна: signal-сервис считает сигнал только по готовой и актуальной job DB."""
