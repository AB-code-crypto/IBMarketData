...
Этот проект не занимается торговлей.
...
- тестера стратегий;
- расчёта PnL;
- торгового recovery/reconcile.

Торговая логика, тестирование стратегий и исполнение сделок должны жить в отдельном проекте.
